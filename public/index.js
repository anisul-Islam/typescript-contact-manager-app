...
const contactService = new ContactService_1.default();
// Add contacts
const contact1 = new Contact_1.default(1, 'Alice', 'alice@example.com', '123-456-7890');
const contact2 = new Contact_1.default(2, 'Bob', 'bob@example.com', '987-654-3210');
...
// Update a contact
const contactIdToUpdate = 2;
const updatedContact = new Contact_1.default(contactIdToUpdate, 'Updated Alice', 'updated@example.com', '555-555-5555');
